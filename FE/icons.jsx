// LuxuryStay — minimal stroke icon set (24x24 viewBox, 1.5 stroke)
const Icon = ({ name, size = 16, className = "", style = {} }) => {
  const paths = {
    ...
    leaf: <path d="M21 3c-12 0-18 6-18 14a4 4 0 0 0 4 4c8 0 14-6 14-18M3 21l8-8" />,
    coffee: <><path d="M3 8h14v6a4 4 0 0 1-4 4H7a4 4 0 0 1-4-4z" /><path d="M17 10h2a2 2 0 0 1 0 4h-2M7 2v3M11 2v3M15 2v3" /></>,
    wifi: <path d="M2 9a16 16 0 0 1 20 0M5 13a11 11 0 0 1 14 0M8.5 16.5a6 6 0 0 1 7 0M12 20h.01" />,
    pool: <path d="M3 17c2 1 3-1 5-1s3 2 5 1 4-2 6-1c1 .3 2 .8 2 .8M3 13c2 1 3-1 5-1s3 2 5 1M7 13V5a3 3 0 0 1 6 0M13 9h-6" />,
    spa: <><circle cx="12" cy="12" r="3" /><path d="M12 3c1 3 1 6-3 9 3 0 5 1 5 5M12 3c-1 3-1 6 3 9-3 0-5 1-5 5M3 12c3-1 6-1 9 3 0-3 1-5 5-5M21 12c-3-1-6-1-9 3 0-3-1-5-5-5" /></>,
