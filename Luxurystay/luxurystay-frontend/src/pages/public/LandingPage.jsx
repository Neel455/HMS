...
const SUITE_PREVIEW = [
  {
    name: 'Deluxe King',
    from: '€480',
    grad: 'linear-gradient(160deg, #EFE8DB, #C9AE82)',
    num: '01',
  },
  {
    name: 'Junior Suite',
    from: '€720',
    grad: 'linear-gradient(160deg, #C9AE82, #806339)',
    num: '02',
  },
  {
    name: 'Premier Suite',
    from: '€1,240',
    grad: 'linear-gradient(160deg, #806339, #2A2620)',
    num: '03',
  },
];
    ...
    <PublicShell>
      ...
      <section style={{
        ...
        <div>
          ...
          <p style={{
            fontSize: 17, color: 'var(--ink-3)', lineHeight: 1.6,
        ...
        <div style={{
          ...
          <div style={{
            ...
            background: 'radial-gradient(circle at 30% 70%, rgba(247, 243, 236, 0.12), transparent 60%)',
          }} />
          <div style={{
            position: 'absolute', bottom: 32, left: 32, right: 32,
            color: 'var(--ivory)',
          }}>
            <div className="eyebrow" style={{ color: 'var(--brass-soft)', marginBottom: 8 }}>
              The Penthouse
            </div>
            <div className="display display-italic" style={{ fontSize: 32 }}>
              From €2,400 / night
            </div>
          </div>
          <div style={{
            position: 'absolute', top: 32, right: 32,
            fontFamily: 'var(--serif)', fontSize: 60, fontStyle: 'italic',
            color: 'rgba(247, 243, 236, 0.15)', lineHeight: 1,
          }}>
            ★
          </div>
        </div>
      ...
      <section style={{ padding: '0 64px 80px' }}>
        ...
        <div style={{
          ...
          border: '1px solid var(--hairline)', marginTop: 48,
        }}>
          {STATS.map((s, i) => (
            <div key={i} style={{
              background: 'var(--paper)', padding: '32px 28px', textAlign: 'center',
            }}>
              <div className="display numeral" style={{ fontSize: 52, lineHeight: 1 }}>
                {s.value}
              </div>
        ...
        <div style={{
          ...
          <a
            ...
            style={{
              ...
              borderBottom: '1px solid var(--ink)', cursor: 'pointer',
            }}
          >
            View all →
          </a>
            ...
            >
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  color: 'rgba(247, 243, 236, 0.2)', lineHeight: 0.8,
                }}>
                  {s.num}
                </div>
              </div>
      ...
      <section style={{
        ...
        <div>
          <div className="eyebrow" style={{ color: 'var(--brass-soft)', marginBottom: 20 }}>
            The house · since 1924
          </div>
